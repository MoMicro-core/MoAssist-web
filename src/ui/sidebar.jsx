...
export const SidebarItem = forwardRef(function SidebarItem(
  ...
  const classes = clsx(
    ...
    "data-[slot=icon]:*:data-[current]:text-[#099ad9]",
    ...
    "dark:data-[slot=icon]:*:data-[current]:text-[#5dd3df]",
  );
    ...
    <span className={clsx(className, "relative")}>
      {current && (
        <motion.span
          ...
          className="absolute inset-y-2 -left-4 w-1 rounded-full bg-gradient-to-b from-[#099ad9] to-[#5cd7d3] dark:from-[#1bb1d4] dark:to-[#5dd3df]"
        />
      )}
      {"href" in props ? (
