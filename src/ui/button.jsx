...
const styles = {
  base: [
    "ui-pressable relative isolate inline-flex items-center justify-center gap-x-2 rounded-lg border text-base/6 font-semibold",
    "px-[calc(theme(spacing[3.5])-1px)] py-[calc(theme(spacing[2.5])-1px)] sm:px-[calc(theme(spacing.3)-1px)] sm:py-[calc(theme(spacing[1.5])-1px)] sm:text-sm/6",
    "data-[hover]:-translate-y-px",
  ...
  colors: {
    ...
    cyan: [
      ...
      "dark:text-[#0b1c2a] dark:[--btn-bg:#def1f2] dark:[--btn-border:rgb(93_211_223_/_0.78)] dark:[--btn-hover-overlay:rgb(27_177_212_/_0.08)]",
    ...
    teal: [
      ...
      "dark:text-[#081521] dark:[--btn-bg:#5dd3df] dark:[--btn-border:rgb(27_177_212_/_0.86)] dark:[--btn-hover-overlay:rgb(252_255_248_/_0.2)]",
      "[--btn-icon:theme(colors.white/60%)] data-[active]:[--btn-icon:theme(colors.white/80%)] data-[hover]:[--btn-icon:theme(colors.white/80%)] dark:[--btn-icon:#173a55] dark:data-[active]:[--btn-icon:#173a55] dark:data-[hover]:[--btn-icon:#173a55]",
    ],
    sky: [
      "text-white [--btn-hover-overlay:theme(colors.white/10%)] [--btn-bg:theme(colors.sky.500)] [--btn-border:theme(colors.sky.600/80%)]",
      "dark:text-[#081521] dark:[--btn-bg:#1bb1d4] dark:[--btn-border:rgb(33_77_111_/_0.9)] dark:[--btn-hover-overlay:rgb(252_255_248_/_0.16)]",
      "[--btn-icon:theme(colors.white/60%)] data-[active]:[--btn-icon:theme(colors.white/80%)] data-[hover]:[--btn-icon:theme(colors.white/80%)] dark:[--btn-icon:#def1f2] dark:data-[active]:[--btn-icon:#def1f2] dark:data-[hover]:[--btn-icon:#def1f2]",
    ],
    blue: [
...
export const Button = forwardRef(function Button(
  ...
  return "href" in props ? (
    <Link {...props} className={clsx(classes, "cursor-pointer")} ref={ref}>
