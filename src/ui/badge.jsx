...
const colors = {
  ...
  teal: "bg-teal-500/15 text-teal-700 group-data-[hover]:bg-teal-500/25 dark:bg-[#1bb1d4]/16 dark:text-[#def1f2] dark:group-data-[hover]:bg-[#1bb1d4]/24",
  cyan: "bg-cyan-400/20 text-cyan-700 group-data-[hover]:bg-cyan-400/30 dark:bg-[#5dd3df]/14 dark:text-[#def1f2] dark:group-data-[hover]:bg-[#5dd3df]/22",
  sky: "bg-sky-500/15 text-sky-700 group-data-[hover]:bg-sky-500/25 dark:bg-[#1bb1d4]/14 dark:text-[#def1f2] dark:group-data-[hover]:bg-[#1bb1d4]/22",
