...
export const marketingContent = {
  en: {
    seo: {
      ...
      ogDescription:
        "Automate 80% of your ecommerce customer questions. MoAssist handles shipping, returns, and product info 24/7 — so you sell more and spend less on support.",
      twitterDescription:
        "AI chatbot for Shopify stores. Reduce support costs by 70%, answer questions instantly, and increase conversions. Setup in under 5 minutes.",
    },
    appDescription:
    ...
    heroHighlights: [
      { title: "70% lower support costs", href: "#problem" },
      { title: "80% auto-answered", href: "#features" },
      { title: "5-min setup", href: "#how-it-works" },
      { title: "Shopify ready", href: "#use-cases" },
    ],
    coreBenefits: [
      {
        title: "Up to 70% reduction in support costs",
        body: "Replace repetitive manual replies with instant AI answers. Every shipping question, return request, and product inquiry handled automatically — no extra headcount needed.",
      },
      {
        title: "More sales, fewer abandoned carts",
        body: "Customers who get instant answers buy. Customers who wait leave. MoAssist keeps buyers moving through checkout by resolving doubts the moment they arise.",
      },
      {
        title: "Live in under 5 minutes — or we set it up for free",
        body: "Paste one line of code, connect your store, and your chatbot is live. If you prefer, our team installs it for you at no cost — no technical skills required.",
      },
    ],
    problemSection: {
      eyebrow: "The Problem",
      title: "Every unanswered question is a lost sale.",
      body: "Your customers expect instant answers. When they don't get them, they don't wait — they buy from someone else.",
      items: [
        { stat: "67%", label: "of online shoppers abandon a purchase due to poor or slow support" },
        { stat: "3 min", label: "average wait time that triggers cart abandonment" },
        { stat: "10+ hrs", label: "wasted weekly answering the same repetitive questions" },
        { stat: "€0", label: "recovered from customers who left without getting an answer" },
      ],
    },
    featuresSection: {
      eyebrow: "What MoAssist does",
      title: "AI that handles support so your team doesn't have to.",
      body: "MoAssist connects to your store, learns your policies and products, and starts answering customer questions automatically — shipping, returns, order tracking, product details, and more.",
    },
    featureSections: [
      createFeature(
        "feature-individual-chatbots",
        "Instant AI customer support",
        "Answer shipping, return, and product questions automatically — around the clock.",
        "Your chatbot handles the questions that flood your inbox every day. Shipping times, return policies, size guides, stock availability — answered instantly without a single manual reply from your team.",
        [
      ...
      createFeature(
        ...
        "Upload your policies, product catalog, and FAQs — the AI learns your business in minutes.",
        "No generic answers. Upload your shipping policy, return terms, product descriptions, and store guides. Your chatbot answers from your actual data, so every reply is accurate and on-brand.",
        [
      ...
      createFeature(
        ...
        "Turn browsing visitors into paying customers with smart, timely engagement.",
        "Your chatbot doesn't just answer questions — it guides visitors toward purchase. Collect emails, qualify buying intent, offer product recommendations, and reduce drop-off at critical funnel points.",
        [
          "Email capture inside chat",
      ...
      createFeature(
        ...
        "Support customers after they buy — not just before.",
        "Handle post-purchase questions automatically. Order status, shipping updates, return initiation, and account help — all resolved without your team lifting a finger.",
        [
      ...
      createFeature(
        ...
        "AI + Human inbox",
        "AI handles the volume. Your team handles the exceptions.",
        "When a situation needs a human touch, your team steps in seamlessly. AI and human replies share one inbox — no context lost, no duplicate effort, no frustrated customers.",
        [
          "AI replies first, team steps in when needed",
          "Shared inbox for full visibility",
      ...
      createFeature(
        ...
        "One-line install — done in 5 minutes",
        "Paste one snippet, go live. Or let our team install it for you, free.",
        "No developer required. Copy one line of code, paste it into your Shopify theme or any website, and your chatbot is live. Prefer someone to do it for you? Our team handles the full installation at no extra cost.",
        [
          "One-line Shopify installation",
          "Free done-for-you setup option",
          "Dark & light mode auto-adapts",
    ...
    reasonsSection: {
      eyebrow: "Why MoAssist",
      title: "Built specifically for ecommerce stores.",
      body: "MoAssist isn't a generic chatbot tool. It's designed for online stores that deal with high support volume, repetitive questions, and the pressure to convert every visitor.",
    },
    reasonCards: [
      {
        title: "Reduces support cost by up to 70%",
        body: "Handle 80% of questions automatically. Pay for AI instead of expanding your support headcount.",
      },
      {
        title: "Increases your conversion rate",
        body: "Customers who get instant answers buy more. Reduce doubt, reduce abandonment, increase revenue.",
      },
      {
        title: "Works with any store design",
        body: "Automatically adapts to your brand colors, dark and light mode. No design work needed.",
      },
      {
        title: "Speaks your customers' language",
        body: "Supports 20+ languages out of the box. Serve international customers without hiring multilingual agents.",
      },
      {
        title: "No technical skills required",
        body: "One-line installation. If that feels like too much, our team sets it up for free. Zero friction.",
      },
      {
        title: "Scales with your store growth",
        body: "Handle 10 conversations or 10,000. The AI scales without additional cost or team expansion.",
      },
    ],
    socialProof: {
      eyebrow: "Results",
      title: "Stores like yours are already saving time and making more money.",
      testimonials: [
        {
          quote: "Within 2 weeks, 80% of our customer questions were handled automatically. Support costs dropped by 60%. I can't believe we waited this long.",
          name: "Sarah M.",
          role: "Shopify Store Owner, Fashion",
          result: "–60% support costs",
        },
        {
          quote: "Setup took under 5 minutes. The chatbot now answers shipping and return questions around the clock. Our team finally has time for real work.",
          name: "Tom B.",
          role: "Dropshipping Brand, Electronics",
          result: "+22% conversion rate",
        },
        {
          quote: "We went from 200 daily support tickets to 35. The ROI paid for itself in the first month. This is a no-brainer for any Shopify store.",
          name: "Elena K.",
          role: "D2C Beauty Brand",
          result: "–83% support tickets",
        },
      ],
      stats: [
        { value: "70%", label: "avg. reduction in support costs" },
        { value: "80%", label: "of questions answered automatically" },
    ...
    comparison: {
      ...
      title: "What changes when you add MoAssist to your store.",
      withoutLabel: "Without MoAssist",
      withLabel: "With MoAssist",
      withoutItems: [
        "Customers wait hours for a reply",
        "Same 10 questions answered manually every day",
        "Abandoned carts from unanswered questions",
        "Support team overwhelmed during peak season",
        "High cost per support ticket",
        "Zero coverage outside business hours",
      ],
      withItems: [
        "Instant answers, 24/7, in any language",
        "80% of questions handled automatically",
        "More conversions, fewer abandoned carts",
        "Team focused on high-value tasks only",
        "Up to 70% lower support costs",
        "Always on — even at 3am on weekends",
      ],
    },
    workflowSection: {
      processLabel: "Setup Process",
      title: "From zero to live chatbot in under 5 minutes.",
      body: "Three steps. No developer. No complexity. Your AI chatbot is live and handling customer questions before you finish your coffee.",
    },
    workflowSteps: [
      {
        step: "Step 01",
    ...
    useCasesSection: {
      eyebrow: "Use Cases",
      title: "Built for how ecommerce actually works.",
      body: "Whether you're running a Shopify store, a dropshipping operation, or a scaling D2C brand — MoAssist adapts to your business, your language, and your store's look.",
    },
    useCases: [
      {
        title: "Shopify stores",
        body: "Install in minutes, train on your product catalog and policies, and start automating customer support immediately. Works with any Shopify theme — dark or light mode.",
      },
      {
        title: "Dropshipping brands",
        body: "Handle the high volume of shipping and delivery questions that come with dropshipping — automatically. Scale support without scaling your team.",
      },
      {
        title: "D2C brands",
        body: "Build a branded support experience that matches your store. Answer product, sizing, and return questions instantly to reduce friction at checkout.",
      },
      {
        title: "High-volume support teams",
        body: "Let AI handle the flood of repetitive tickets so your agents can focus on complex cases that actually need human judgment.",
      },
    ],
    faqSection: {
      eyebrow: "FAQ",
      title: "Common questions about MoAssist.",
      body: "Everything Shopify store owners and ecommerce brands ask before getting started.",
    },
    faqItems: [
      {
        question: "What is an AI chatbot for ecommerce?",
        answer:
          "An AI chatbot for ecommerce automatically answers customer questions on your store — shipping times, return policies, product details, order status — without a human agent. MoAssist is trained on your store data so every answer is accurate and specific to your business.",
      },
      {
        question: "Does it work with Shopify?",
        answer:
          "Yes. MoAssist works with Shopify and any ecommerce platform or website. Installation takes under 5 minutes — paste one line of code into your Shopify theme, or let our team do it for you for free.",
      },
      {
        question: "How much can I save on customer support costs?",
        answer:
          "Stores using MoAssist typically reduce support costs by 50–70%. When 80% of questions are answered automatically, you need far fewer hours from your team — and you never need to hire for volume spikes.",
      },
      {
        question: "Can it replace my support agents?",
        answer:
          "It replaces the repetitive part of support — the same 10 questions asked 50 times a day. Your agents stay for complex cases that need a human. Most teams redirect agents toward higher-value tasks rather than cutting headcount.",
      },
      {
        question: "How long does setup take?",
        answer:
          "Under 5 minutes for most stores. Paste one line of code, upload your store policies and FAQs, and go live. If you prefer, our team handles the full setup at no extra cost.",
      },
      {
        question: "Do I need technical skills to install it?",
        answer:
          "No. If you can paste text into a field, you can install MoAssist. And if you'd rather not touch the code at all, our team does the installation for free.",
      },
      {
        question: "Does it support multiple languages?",
        answer:
          "Yes. MoAssist supports 20+ languages out of the box. It automatically detects the customer's language and responds accordingly — no extra configuration needed.",
      },
      {
        question: "Will it match my website or store design?",
        answer:
          "Yes. MoAssist automatically adapts to your site's color scheme and switches between dark and light mode based on your store's theme. You can also fully customize colors, fonts, and the chatbot's appearance.",
      },
      {
        question: "Can I try it before paying?",
        answer:
          "Yes. MoAssist offers a free trial with no credit card required. Set up a chatbot, upload your data, and test it on your store before committing to a plan.",
      },
    ],
    ctaSection: {
      eyebrow: "Start Today",
      title: "Reduce your support costs this week.",
      body: "Set up in under 5 minutes. Train it on your store data. Watch it handle shipping questions, returns, and product inquiries automatically — while your team focuses on growing the business. We can set it up for you for free if you prefer.",
    },
    footerTagline: "AI customer support automation for ecommerce stores.",
  ...
  at: {
    ...
    featureSections: [
      createFeature(
        ...
        "MoAssist Dashboard mit einzelnen KI-Chatbots für verschiedene E-Commerce-Shops und Vertriebskanäle",
        "MoAssist KI-Chatbot-Widget beantwortet Versand-, Rücksende- und Produktfragen für Shopify-Store-Kunden",
      ),
      createFeature(
        "feature-knowledge-ai",
        ...
        "MoAssist Wissensdatenbank lädt E-Commerce-Produktdokumente und FAQs hoch",
        "MoAssist KI trainiert auf Shopify-Store-Daten mit Richtlinien, Produkten und Kunden-FAQs",
      ),
      createFeature(
        "feature-lead-capture",
        ...
        "MoAssist Chatbot erfasst Leads und stellt verlassene Warenkörbe im E-Commerce-Store wieder her",
        "MoAssist KI-Chatbot erhöht E-Commerce-Conversions durch intelligente Lead-Erfassung und Produktempfehlungen",
      ),
      createFeature(
        "feature-logged-in-users",
        ...
        "MoAssist Chatbot zeigt Bestellverfolgung und Versandstatus für authentifizierte E-Commerce-Kunden",
        "MoAssist KI verwaltet Kundensupport nach dem Kauf mit Bestellverfolgung und Rückgabeverwaltung",
      ),
      createFeature(
        "feature-support-workflow",
        ...
        "MoAssist gemeinsamer Postfach zeigt KI- und Kundenbetreuer-Gesprächsverwaltung für E-Commerce-Support",
        "MoAssist einheitlicher Postfach mit nahtlosen KI-zu-Mensch-Übergängen für Kundenservice-Teams",
      ),
      createFeature(
        "feature-install-launch",
        ...
        "MoAssist Code-Snippet aus einer Zeile für die Shopify-Chatbot-Installation",
        "MoAssist 5-Minuten-Setup zeigt dunklen und hellen Modus für E-Commerce-Store-Widgets",
      ),
    ],
    reasonsSection: {
    ...
    heroImageTitle: "MoAssist KI-Chatbot für Onlineshops",
    heroImageAlt: "MoAssist KI-Chatbot-Widget im Shopify-Store beantwortet Kundenfragen zu Versand und Rückgäben in Echtzeit",
  },
  es: {
    seo: {
    ...
    featureSections: [
      createFeature(
        ...
        "Panel de MoAssist mostrando chatbots individuales con IA para diferentes tiendas de e-commerce y canales de ventas",
        "Widget de chatbot con IA de MoAssist respondiendo preguntas de envío, devoluciones y productos para clientes de tiendas Shopify",
      ),
      createFeature(
        "feature-knowledge-ai",
        ...
        "Base de conocimiento de MoAssist cargando documentos de productos de e-commerce y preguntas frecuentes",
        "MoAssist con IA entrenada en datos de tiendas Shopify incluyendo políticas, productos y preguntas frecuentes de clientes",
      ),
      createFeature(
        "feature-lead-capture",
        ...
        "Chatbot de MoAssist capturando leads y recuperando carritos abandonados en tienda de e-commerce",
        "Chatbot con IA de MoAssist aumentando conversiones de e-commerce con captura inteligente de leads y recomendaciones de productos",
      ),
      createFeature(
        "feature-logged-in-users",
        ...
        "Chatbot de MoAssist mostrando seguimiento de pedidos y estado de envío para clientes de e-commerce identificados",
        "IA de MoAssist gestionando soporte posterior a la compra con seguimiento de pedidos y gestión de devoluciones",
      ),
      createFeature(
        "feature-support-workflow",
        ...
        "Bandeja de entrada compartida de MoAssist mostrando gestión de conversaciones entre IA y agentes para soporte de e-commerce",
        "Bandeja de entrada unificada de MoAssist con traspaso fluido de IA a humanos para equipos de atención al cliente",
      ),
      createFeature(
        "feature-install-launch",
        ...
        "Fragmento de código de una línea de MoAssist para instalación de chatbot Shopify",
        "Configuración de 5 minutos de MoAssist mostrando widgets de modo oscuro y claro en tienda de e-commerce",
      ),
    ],
    reasonsSection: {
