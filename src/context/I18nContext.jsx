...
const dictionary = {
  en: {
    ...
    pluginMobileBody:
      "Load this URL inside a WebView to add the chatbot to a native iOS or Android app. Hybrid apps (Capacitor, Cordova, Ionic) can paste the website script instead.",
    pluginAuthBody:
      "Copy the website session snippet so the chatbot can recognize signed-in customers before the widget loads.",
    dashboardScriptBody:
      "Copy the admin panel script to embed the live conversation inbox inside your own back office. Your team signs in with the username and password from the External dashboard tab — no token needed.",
    dashboardIframeBody:
    ...
    externalDashboardTab: "External dashboard",
    externalDashboardTitle: "External dashboard login",
    externalDashboardBody:
      "Give your team a username and password to open this chatbot's inbox from your own site. They see and reply to conversations for this chatbot only.",
    externalDashboardEnableLabel: "Enable external dashboard",
    externalDashboardEnableDesc:
      "When on, your team can sign in to the embedded dashboard with the credentials below.",
    externalDashboardUsername: "Username",
    externalDashboardPassword: "Password",
    externalDashboardPasswordSet: "At least 8 characters.",
    externalDashboardPasswordKeep:
      "Leave blank to keep the current password.",
    externalDashboardShow: "Show",
    externalDashboardHide: "Hide",
    externalDashboardSave: "Save changes",
    externalDashboardSaving: "Saving…",
    externalDashboardSaved: "Saved.",
    externalDashboardEmbedTitle: "Embed code",
    externalDashboardEmbedBody:
  ...
  de: {
    ...
    pluginMobileBody:
      "Laden Sie diese URL in einer WebView, um den Chatbot zu einer nativen iOS- oder Android-App hinzuzufügen. Hybride Apps (Capacitor, Cordova, Ionic) können stattdessen das Website-Skript einfügen.",
    pluginAuthBody:
      "Kopiere das Session-Snippet deiner Website, damit der Chatbot angemeldete Kunden erkennt, bevor das Widget geladen wird.",
    dashboardScriptBody:
      "Kopiere das Adminbereich-Script, um den Live-Konversationsbereich in dein eigenes Backoffice einzubetten. Dein Team meldet sich mit Benutzername und Passwort aus dem Tab Externes Dashboard an — kein Token noetig.",
    dashboardIframeBody:
  ...
  es: {
    ...
    pluginMobileBody:
      "Carga esta URL dentro de un WebView para añadir el chatbot a una app nativa de iOS o Android. Las apps híbridas (Capacitor, Cordova, Ionic) pueden pegar el script del sitio.",
    pluginAuthBody:
    ...
    dashboardScriptBody:
      "Copia el script del panel admin para insertar la bandeja de conversaciones en tu propio back office. Tu equipo inicia sesion con el usuario y la contrasena de la pestana Panel externo, sin token.",
    dashboardIframeBody:
...
dictionary.fr = {
  ...
  pluginMobileBody: "Chargez cette URL dans une WebView pour ajouter le chatbot à une application iOS ou Android native. Les applications hybrides (Capacitor, Cordova, Ionic) peuvent coller le script du site.",
...
dictionary.it = {
  ...
  pluginMobileBody: "Carica questo URL in una WebView per aggiungere il chatbot a un'app nativa iOS o Android. Le app ibride (Capacitor, Cordova, Ionic) possono incollare lo script del sito.",
...
dictionary.ru = {
  ...
  pluginMobileBody: "Откройте этот URL внутри WebView, чтобы добавить чат-бота в нативное приложение iOS или Android. Гибридные приложения (Capacitor, Cordova, Ionic) могут вставить скрипт сайта.",
...
dictionary.ua = {
  ...
  pluginMobileBody: "Відкрийте цей URL у WebView, щоб додати чат-бота в нативний застосунок iOS або Android. Гібридні застосунки (Capacitor, Cordova, Ionic) можуть вставити скрипт сайту.",
