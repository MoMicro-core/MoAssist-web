...
const dictionary = {
  en: {
    ...
    customBrandingUpgradeHint:
      "Move to any paid plan to upload your own chatbot logo and choose the background behind it.",
  ...
  de: {
    ...
    customBrandingUpgradeHint:
      "Wechsle zu einem kostenpflichtigen Tarif, um ein eigenes Chatbot-Logo hochzuladen und den Hintergrund dahinter festzulegen.",
    bubbleIconUrlLabel: "Bubble Icon URL",
  ...
  es: {
    ...
    customBrandingUpgradeHint:
      "Pasa a cualquier plan de pago para subir tu propio logo del chatbot y elegir el fondo que aparece detras.",
