...
const dictionary = {
  en: {
    ...
    billingPerChatbotBody: 'Billing is managed per chatbot. Select one to continue.',
  ...
  de: {
    ...
    subscription: 'Abo',
    billingPerChatbotBody: 'Abrechnung ist pro Chatbot. Bitte waehle einen Chatbot aus.',
    billingChatbot: 'Abrechnungs Chatbot',
    noChatbotsForBilling: 'Erstelle zuerst einen Chatbot, um Abrechnung zu verwalten.',
  ...
  es: {
    ...
    billingPerChatbotBody: 'La facturacion se gestiona por chatbot. Selecciona uno para continuar.',
